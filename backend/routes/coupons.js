...
//yeni bir kupon oluşturma (create oluşturma)
router.post("/", async (req, res) => {
  try {
    ...
    if (existingCoupon) {
      return res.status(400).json({ eror: "this coupon is already exists." });
    }
...
//Belirli bir kupoa göre getirme (Read-single by Coupon ID)
...
//Belirli bir kupoa göre getirme (Read-single by Coupon Code)
...
router.get("/code/:couponCode", async (req, res) => {
  try {
    ...
    // sadece discountPercent çıkar postman de
